        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                	<div >
						<form method="POST" action="ListPaymentHistoryServlet1">
						<table>
							
								<button type="submit" class="btn btn-success" value="List Payment History" >List Payment History</button>
                    ...
                    <form method="POST" action="AddPaymentServlet1">
					  ...
					  <div class="form-group row">
						...
						<div class="form-group row">
						    <label class="col-sm-2 col-form-label">Card Number</label>
				  		  	<div class="form-check">
					  		  	<div class="col-sm-10">
					  		  		<input type="text" class="form-control" name="cardNumber" required="required">
					  		  	</div>
							</div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="expDate" required="required" >
					    </div>
					    
					  </div>
					  <div class="form-group row">
						    <label class="col-sm-2 col-form-label">CVC/CVV Number</label>
				  		  	<div class="form-check">
					  		  	<div class="col-sm-10">
					  		  		<input type="text" class="form-control" name="cvc" required="required">
					  		  	</div>
							</div>
					  ...
					  <button type="submit" class="btn btn-primary" value="Make the payment" >Make the payment</button>
