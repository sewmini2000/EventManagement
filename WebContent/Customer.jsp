                ...
                <div class="col-sm-12 col-md-12 well" id="content">
                	<div >
						...
						<table>
								...
								<button type="submit" class="btn btn-success" value="List All Customers">List All Employees</button>
                    ...
                    <form method="POST" action="AddCustomerServlet">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="nIC" required="required" >
					    </div>
					  ...
					  <button type="submit" class="btn btn-primary" value="Add Customer" >Submit</button>
