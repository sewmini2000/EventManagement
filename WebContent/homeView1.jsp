        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                	<div >
						<form method="POST" action="ListEventServlet1">
						<table>
							
								<button type="submit" class="btn btn-success" value="List All Events" >List All Event</button>
                    ...
                    <form method="POST" action="AddEventServlet1">
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="quantity" required="required" onChange="calculatePrice()" id="qnt">
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="hours" required="required" onChange="calculatePrice()" id="hours">
					    </div>
					  </div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="description" required="required" id="total">
					    </div>
					    
					  </div>
					  
					  <button type="submit" class="btn btn-primary" value="Add Event" >Submit</button>
