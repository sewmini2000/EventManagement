        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                	<div >
						<form method="POST" action="ListSupplierServlet1">
						<table>
							
								<button type="submit" class="btn btn-success" value="List All Suppliers" >List All Suppliers</button>
                    ...
                    <form method="POST" action="AddSupplierServlet1">
					  ...
					  <div class="form-group row">
						    <label class="col-sm-2 col-form-label">Items & Services</label>
				  		  	<div class="form-check">
					  		  	<div class="col-sm-10">
					  		  		<input type="text" class="form-control" name="itemsServices" required="required">
					  		  	</div>
							</div>
					  ...
					  <div class="form-group row">
					    ...
					    <div class="col-sm-10">
					    	<input type="text" class="form-control" name="discounts" required="required" >
					    </div>
					    
					  </div>
					  
					  <button type="submit" class="btn btn-primary" value="Add Supplier" >Add Supplier</button>
