...
<%@page import="service.SupplierServiceImpl"%>
<%@page import="service.ISupplierService"%>
            	...
            	%>
					  <tbody>
					    <tr>
							...
							<td> <%=supplier.getItemsServices() %> </td>
							<td> <%=supplier.getPrice() %> </td>
							<td> <%=supplier.getDiscounts() %> </td>		
							<td> 
							<form method="POST" action="GetSupplierServlet1">
								<input type="hidden" name="supplierID" value="<%=supplier.getSupplierID()%>"/>
								<button type="submit" class="btn btn-primary" value= "Select Supplier" >Edit</button>
							 </form>
							 </td>
