        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
				...
				<%
                    ...
                    ArrayList<Payment_info> arrayList = iPaymentService.getPayment();
                                    	
                    for(Payment_info payment : arrayList){
            	%>
					  <tbody>
					    <tr>
							...
							<td> <%=payment.getCvc() %> </td>
							<td> <%=payment.getTotal() %> </td>		
							<td> 
							<form method="POST" action="GetPaymentServlet1">
								<input type="hidden" name="paymentID" value="<%=payment.getPaymentID()%>"/>
								<button type="submit" class="btn btn-primary" value= "Select Payement" >Edit</button>
							 </form>
							 </td>
