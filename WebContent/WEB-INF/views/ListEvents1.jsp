...
<%@page import="service.EventServiceImpl"%>
                ...
                <table class="table table-striped">
					  ...
					  <tbody>
					    <tr>
							...
							<td> <%=event.getHours() %> </td>
							<td> <%=event.getLocation() %> </td>
							<td> <%=event.getTime() %> </td>
							<td> <%=event.getDescription() %> </td>
								
							<td> 
							<form method="POST" action="GetEventServlet1">
							<input type="hidden" name="eventID" value="<%=event.getEventID()%>"/>
							<button type="submit" class="btn btn-primary" value= "Select Event" >Select Event</button>
							 </form>
							 </td>
